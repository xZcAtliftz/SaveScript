...
page:Label("Bypass ใช้งานไม่ได้ รอทำใหม่")
...
page:Toggle("Auto Farm Tp Bypass [ Not Work ]", _G.AutoFarmLevel, function(vu)
    _G.AutoFarmtp = vu
end)
...
spawn(function()
 ...
 page:Button("Bypass [ Not Work ]", function(t)
...
Tab8:Button("Korblox",function()
	local ply = game.Players.LocalPlayer local chr = ply.Character chr.RightLowerLeg.MeshId = "902942093" chr.RightLowerLeg.Transparency = "1" chr.RightUpperLeg.MeshId = "http://www.roblox.com/asset/?id=902942096" chr.RightUpperLeg.TextureID = "http://roblox.com/asset/?id=902843398" chr.RightFoot.MeshId = "902942089" chr.RightFoot.Transparency = "1"
end)
